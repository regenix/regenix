...
set VENDOR_PATH=%REGENIX_PATH%framework/vendor/
...
set DEFAULT_PROPEL_GEN_HOME=%VENDOR_PATH%Propel/generator

if "%PROPEL_GEN_HOME%" == "" set PROPEL_GEN_HOME=%DEFAULT_PROPEL_GEN_HOME%
set DEFAULT_PROPEL_GEN_HOME=

if "%PHING_COMMAND%" == "" set PHING_COMMAND=%VENDOR_PATH%Phing/bin/phing.bat
