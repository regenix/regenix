...
заголовки, *Session* - управление сессией, *Flash* - управление живущими один запрос flash сообщениями,
...
всегда имеется возможность вывести неэкранированную переменную. И всегда остается возможность использовать
...
Или попробуем реализовать класс с реализацией binding'a, для этого его надо унаследовать
