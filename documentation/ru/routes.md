...
В фреймворке есть возможно добавить правило роутинга динамически - с помощью кода.
Для этого необходимо использовать класс Router и его мето addRoute. Обычно такое
