...
use framework\mvc\AbstractModelCursor;
...
class Service extends AbstractService {
    ...
    public function findByFilter(array $filter, array $fields = array(), $lazy = false){
        return new ModelCursor($this->collection->find($filter, $fields), $this, $lazy);
    }
    ...
    public function findByFilterAndModify(array $filter, array $update, array $fields = array(), $lazy = false){
        return new ModelCursor($this->collection->findAndModify($filter, $update, $fields), $this, $lazy);
    }
...
class ModelCursor extends AbstractModelCursor {
